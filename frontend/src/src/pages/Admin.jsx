...
const Admin = ({ navigate, token, onLogout }) => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-black via-sky-950 to-black text-slate-50 flex flex-col">
      ...
      <div className="relative mx-auto max-w-6xl pb-16 pt-8 lg:px-8 flex-1">
        {/* Header */}
        ...
        {/* Tabela */}
        <section className="rounded-3xl border border-sky-800/60 bg-black/80 p-5 shadow-xl shadow-sky-500/20">
          {loading ? (
  ...
  <div className="flex flex-col">
    ...
    {tx.phone && (
      <span className="text-[12px] text-sky-300">
        ...
        {/* WhatsApp Requests */}
        <section className="mt-8 rounded-3xl border border-sky-800/60 bg-black/80 p-5 shadow-xl shadow-sky-500/20">
